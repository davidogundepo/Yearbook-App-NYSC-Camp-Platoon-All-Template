...
class MyPlatoonTwoSearch extends SearchDelegate {
  final List all;

  bool _isVisible = true;

  MyPlatoonTwoSearch({@required this.all});
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((platoonTwo) => platoonTwo.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((platoonTwo) => platoonTwo.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          platoonTwoNotifier.currentPlatoonTwo = search[position];
