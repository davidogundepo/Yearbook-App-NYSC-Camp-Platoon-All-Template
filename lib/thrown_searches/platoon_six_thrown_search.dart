...
class MyPlatoonSixSearch extends SearchDelegate {
  final List all;

  bool _isVisible = true;

  MyPlatoonSixSearch({@required this.all});
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((platoonSix) => platoonSix.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((platoonSix) => platoonSix.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          platoonSixNotifier.currentPlatoonSix = search[position];
