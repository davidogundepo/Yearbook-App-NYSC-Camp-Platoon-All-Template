...
class MyPlatoonFiveSearch extends SearchDelegate {
  final List all;

  bool _isVisible = true;

  MyPlatoonFiveSearch({@required this.all});
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((platoonFive) => platoonFive.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((platoonFive) => platoonFive.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          platoonFiveNotifier.currentPlatoonFive = search[position];
