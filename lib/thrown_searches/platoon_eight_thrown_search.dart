...
Color modalColor = Color.fromRGBO(97, 164, 188, 1);
...
Color dialogBackgroundColor = Color.fromRGBO(97, 164, 188, 1);
Color borderColor = Colors.black;
Color textHighlightColor = Colors.white;

var queryTech;

class MyPlatoonEightSearch extends SearchDelegate {
  final List all;

  bool _isVisible = true;

  MyPlatoonEightSearch({@required this.all});
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((platoonEight) => platoonEight.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((platoonEight) => platoonEight.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          platoonEightNotifier.currentPlatoonEight = search[position];
