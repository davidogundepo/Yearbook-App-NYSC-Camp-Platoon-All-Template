...
Color modalColor = Color.fromRGBO(179, 48, 48, 1);
...
Color dialogBackgroundColor = Color.fromRGBO(179, 48, 48, 1);
Color borderColor = Colors.black;
Color textHighlightColor = Colors.white;

var queryTech;

class MyPlatoonThreeSearch extends SearchDelegate {
  final List all;

  bool _isVisible = true;

  MyPlatoonThreeSearch({@required this.all});
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((platoonThree) => platoonThree.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((platoonThree) => platoonThree.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          platoonThreeNotifier.currentPlatoonThree = search[position];
