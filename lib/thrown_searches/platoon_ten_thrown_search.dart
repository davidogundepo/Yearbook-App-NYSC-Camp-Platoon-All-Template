...
class MyPlatoonTenSearch extends SearchDelegate {
  final List all;

  bool _isVisible = true;

  MyPlatoonTenSearch({@required this.all});
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((platoonTen) => platoonTen.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((platoonTen) => platoonTen.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          platoonTenNotifier.currentPlatoonTen = search[position];
