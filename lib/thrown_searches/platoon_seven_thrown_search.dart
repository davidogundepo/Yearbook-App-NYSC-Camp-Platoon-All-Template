...
class MyPlatoonSevenSearch extends SearchDelegate {
  final List all;

  bool _isVisible = true;

  MyPlatoonSevenSearch({@required this.all});
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((platoonSeven) => platoonSeven.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((platoonSeven) => platoonSeven.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          platoonSevenNotifier.currentPlatoonSeven = search[position];
