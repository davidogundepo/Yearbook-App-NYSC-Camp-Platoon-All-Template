...
class MyPlatoonNineSearch extends SearchDelegate {
  final List all;

  bool _isVisible = true;

  MyPlatoonNineSearch({@required this.all});
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((platoonNine) => platoonNine.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((platoonNine) => platoonNine.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          platoonNineNotifier.currentPlatoonNine = search[position];
