...
class MyPlatoonFourSearch extends SearchDelegate {
  final List all;

  bool _isVisible = true;

  MyPlatoonFourSearch({@required this.all});
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((platoonFour) => platoonFour.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((platoonFour) => platoonFour.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          platoonFourNotifier.currentPlatoonFour = search[position];
