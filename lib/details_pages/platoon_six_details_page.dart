...
PlatoonSixNotifier platoonSixNotifier;
...
class PlatoonSixDetailsPage extends StatefulWidget {
  @override
  _PlatoonSixDetailsPageState createState() => _PlatoonSixDetailsPageState();
}

class _PlatoonSixDetailsPageState extends State<PlatoonSixDetailsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    platoonSixNotifier = Provider.of<PlatoonSixNotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(platoonSixNotifier.currentPlatoonSix.nickname,
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: platoonSixNotifier.currentPlatoonSix.image,
                        fit: BoxFit.cover,
                  ...
                  message: platoonSixNotifier.currentPlatoonSix.name
              ),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(platoonSixNotifier.currentPlatoonSix.name.toUpperCase(),
                            ...
                            (() {
                              if (platoonSixNotifier.currentPlatoonSix.platoonExecutive == "Yes") {
                                return
                                  Row(
                                    children: <Widget>[
                                      SizedBox(width: 10),
  ...
  initState(){
    ...
    PlatoonSixNotifier platoonSixNotifier = Provider.of<PlatoonSixNotifier>(context, listen: false);

    _autoBio = platoonSixNotifier.currentPlatoonSix.autoBio;
    _bestMoment = platoonSixNotifier.currentPlatoonSix.bestMoment;
    _courseOfStudy = platoonSixNotifier.currentPlatoonSix.courseOfStudy;
    _graduationYear = platoonSixNotifier.currentPlatoonSix.graduationYear;
    _linkedIn = platoonSixNotifier.currentPlatoonSix.linkedIn;
    _desiredPpaAssignment = platoonSixNotifier.currentPlatoonSix.desiredPpaAssignment;
    _platoonExecutive = platoonSixNotifier.currentPlatoonSix.platoonExecutive;
    _platoonExecutivePosition = platoonSixNotifier.currentPlatoonSix.platoonExecutivePosition;
    _desiredPpaLocation = platoonSixNotifier.currentPlatoonSix.desiredPpaLocation;
    _originState = platoonSixNotifier.currentPlatoonSix.stateOfOrigin;
    _whatsNext = platoonSixNotifier.currentPlatoonSix.whatsNext;
    _stateLiving = platoonSixNotifier.currentPlatoonSix.whereYouLive;
    _bestMoment = platoonSixNotifier.currentPlatoonSix.bestMoment;
    _dob = platoonSixNotifier.currentPlatoonSix.dob;
    _academicQualification = platoonSixNotifier.currentPlatoonSix.academicQualification;
    _almaMater = platoonSixNotifier.currentPlatoonSix.almaMater;
    _email = platoonSixNotifier.currentPlatoonSix.email;
    _facebook = platoonSixNotifier.currentPlatoonSix.facebook;
    _hobbies = platoonSixNotifier.currentPlatoonSix.hobbies;
    _instagram = platoonSixNotifier.currentPlatoonSix.instagram;
    _snapchat = platoonSixNotifier.currentPlatoonSix.snapchat;
    _tikTok = platoonSixNotifier.currentPlatoonSix.tikTok;
    _telegram = platoonSixNotifier.currentPlatoonSix.telegram;
    _myDropline = platoonSixNotifier.currentPlatoonSix.myDropline;
    _name = platoonSixNotifier.currentPlatoonSix.name;
    _nickname = platoonSixNotifier.currentPlatoonSix.nickname;
    _philosophy = platoonSixNotifier.currentPlatoonSix.philosophy;
    ...
    _matchPast = platoonSixNotifier.currentPlatoonSix.matchPastInCamp;
