...
Color shapeDecorationColor = Color.fromRGBO(26, 95, 122, 1);
Color shapeDecorationTextColor = Color.fromRGBO(26, 95, 122, 1);
Color cardBackgroundColor = Colors.white;
Color cardThumbColor = Colors.white;
Color cardThumbBackgroundColor = Color.fromRGBO(26, 95, 122, 1);
Color splashColor = Color.fromRGBO(26, 95, 122, 1);
Color splashColorTwo = Colors.white;
Color iconTextColor = Color.fromRGBO(26, 95, 122, 1);
Color iconTextColorTwo = Colors.white;
Color buttonColor = Color.fromRGBO(26, 95, 122, 1);
Color textColor = Color.fromRGBO(26, 95, 122, 1);
...
PlatoonTwoNotifier platoonTwoNotifier;
...
class PlatoonTwoDetailsPage extends StatefulWidget {
  @override
  _PlatoonTwoDetailsPageState createState() => _PlatoonTwoDetailsPageState();
}

class _PlatoonTwoDetailsPageState extends State<PlatoonTwoDetailsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    platoonTwoNotifier = Provider.of<PlatoonTwoNotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(platoonTwoNotifier.currentPlatoonTwo.nickname,
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: platoonTwoNotifier.currentPlatoonTwo.image,
                        fit: BoxFit.cover,
                  ...
                  message: platoonTwoNotifier.currentPlatoonTwo.name
              ),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(platoonTwoNotifier.currentPlatoonTwo.name.toUpperCase(),
                            ...
                            (() {
                              if (platoonTwoNotifier.currentPlatoonTwo.platoonExecutive == "Yes") {
                                return
                                  Row(
                                    children: <Widget>[
                                      SizedBox(width: 10),
  ...
  initState(){
    ...
    _autoBio = platoonTwoNotifier.currentPlatoonTwo.autoBio;
    _bestMoment = platoonTwoNotifier.currentPlatoonTwo.bestMoment;
    _courseOfStudy = platoonTwoNotifier.currentPlatoonTwo.courseOfStudy;
    _graduationYear = platoonTwoNotifier.currentPlatoonTwo.graduationYear;
    _linkedIn = platoonTwoNotifier.currentPlatoonTwo.linkedIn;
    _desiredPpaAssignment = platoonTwoNotifier.currentPlatoonTwo.desiredPpaAssignment;
    _platoonExecutive = platoonTwoNotifier.currentPlatoonTwo.platoonExecutive;
    _platoonExecutivePosition = platoonTwoNotifier.currentPlatoonTwo.platoonExecutivePosition;
    _desiredPpaLocation = platoonTwoNotifier.currentPlatoonTwo.desiredPpaLocation;
    _originState = platoonTwoNotifier.currentPlatoonTwo.stateOfOrigin;
    _whatsNext = platoonTwoNotifier.currentPlatoonTwo.whatsNext;
    _stateLiving = platoonTwoNotifier.currentPlatoonTwo.whereYouLive;
    _bestMoment = platoonTwoNotifier.currentPlatoonTwo.bestMoment;
    _dob = platoonTwoNotifier.currentPlatoonTwo.dob;
    _academicQualification = platoonTwoNotifier.currentPlatoonTwo.academicQualification;
    _almaMater = platoonTwoNotifier.currentPlatoonTwo.almaMater;
    _email = platoonTwoNotifier.currentPlatoonTwo.email;
    _facebook = platoonTwoNotifier.currentPlatoonTwo.facebook;
    _hobbies = platoonTwoNotifier.currentPlatoonTwo.hobbies;
    _instagram = platoonTwoNotifier.currentPlatoonTwo.instagram;
    _snapchat = platoonTwoNotifier.currentPlatoonTwo.snapchat;
    _tikTok = platoonTwoNotifier.currentPlatoonTwo.tikTok;
    _telegram = platoonTwoNotifier.currentPlatoonTwo.telegram;
    _myDropline = platoonTwoNotifier.currentPlatoonTwo.myDropline;
    _name = platoonTwoNotifier.currentPlatoonTwo.name;
    _nickname = platoonTwoNotifier.currentPlatoonTwo.nickname;
    _philosophy = platoonTwoNotifier.currentPlatoonTwo.philosophy;
    _phone = platoonTwoNotifier.currentPlatoonTwo.phone;
    _twitter = platoonTwoNotifier.currentPlatoonTwo.twitter;
    _worstMoment = platoonTwoNotifier.currentPlatoonTwo.worstMoment;
    _occupation = platoonTwoNotifier.currentPlatoonTwo.occupation;
    _favPlaceInCamp = platoonTwoNotifier.currentPlatoonTwo.favPlaceInCamp;
    _favCampActivity = platoonTwoNotifier.currentPlatoonTwo.favCampActivity;
    _matchPast = platoonTwoNotifier.currentPlatoonTwo.matchPastInCamp;
