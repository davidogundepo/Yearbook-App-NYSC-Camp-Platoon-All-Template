...
Color backgroundColor = Color.fromRGBO(84, 186, 185, 1);
Color appBarTextColor = Colors.white;
Color appBarBackgroundColor = Color.fromRGBO(84, 186, 185, 1);
Color appBarIconColor = Colors.white;
Color materialBackgroundColor = Colors.transparent;
Color shapeDecorationColor = Color.fromRGBO(84, 186, 185, 1);
Color shapeDecorationTextColor = Color.fromRGBO(84, 186, 185, 1);
Color cardBackgroundColor = Colors.white;
Color cardThumbColor = Colors.white;
Color cardThumbBackgroundColor = Color.fromRGBO(84, 186, 185, 1);
Color splashColor = Color.fromRGBO(84, 186, 185, 1);
Color splashColorTwo = Colors.white;
Color iconTextColor = Color.fromRGBO(84, 186, 185, 1);
Color iconTextColorTwo = Colors.white;
Color buttonColor = Color.fromRGBO(84, 186, 185, 1);
Color textColor = Color.fromRGBO(57, 129, 128, 1.0);
...
PlatoonTenNotifier platoonTenNotifier;
...
class PlatoonTenDetailsPage extends StatefulWidget {
  @override
  _PlatoonTenDetailsPageState createState() => _PlatoonTenDetailsPageState();
}

class _PlatoonTenDetailsPageState extends State<PlatoonTenDetailsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    platoonTenNotifier = Provider.of<PlatoonTenNotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(platoonTenNotifier.currentPlatoonTen.nickname,
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: platoonTenNotifier.currentPlatoonTen.image,
                        fit: BoxFit.cover,
                  ...
                  message: platoonTenNotifier.currentPlatoonTen.name
              ),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(platoonTenNotifier.currentPlatoonTen.name.toUpperCase(),
                            ...
                            (() {
                              if (platoonTenNotifier.currentPlatoonTen.platoonExecutive == "Yes") {
                                return
                                  Row(
                                    children: <Widget>[
                                      SizedBox(width: 10),
  ...
  initState(){
    ...
    PlatoonTenNotifier platoonTenNotifier = Provider.of<PlatoonTenNotifier>(context, listen: false);

    _autoBio = platoonTenNotifier.currentPlatoonTen.autoBio;
    _bestMoment = platoonTenNotifier.currentPlatoonTen.bestMoment;
    _courseOfStudy = platoonTenNotifier.currentPlatoonTen.courseOfStudy;
    _graduationYear = platoonTenNotifier.currentPlatoonTen.graduationYear;
    _linkedIn = platoonTenNotifier.currentPlatoonTen.linkedIn;
    _desiredPpaAssignment = platoonTenNotifier.currentPlatoonTen.desiredPpaAssignment;
    _platoonExecutive = platoonTenNotifier.currentPlatoonTen.platoonExecutive;
    _platoonExecutivePosition = platoonTenNotifier.currentPlatoonTen.platoonExecutivePosition;
    _desiredPpaLocation = platoonTenNotifier.currentPlatoonTen.desiredPpaLocation;
    _originState = platoonTenNotifier.currentPlatoonTen.stateOfOrigin;
    _whatsNext = platoonTenNotifier.currentPlatoonTen.whatsNext;
    _stateLiving = platoonTenNotifier.currentPlatoonTen.whereYouLive;
    _bestMoment = platoonTenNotifier.currentPlatoonTen.bestMoment;
    _dob = platoonTenNotifier.currentPlatoonTen.dob;
    _academicQualification = platoonTenNotifier.currentPlatoonTen.academicQualification;
    _almaMater = platoonTenNotifier.currentPlatoonTen.almaMater;
    _email = platoonTenNotifier.currentPlatoonTen.email;
    _facebook = platoonTenNotifier.currentPlatoonTen.facebook;
    _hobbies = platoonTenNotifier.currentPlatoonTen.hobbies;
    _instagram = platoonTenNotifier.currentPlatoonTen.instagram;
    _snapchat = platoonTenNotifier.currentPlatoonTen.snapchat;
    _tikTok = platoonTenNotifier.currentPlatoonTen.tikTok;
    _telegram = platoonTenNotifier.currentPlatoonTen.telegram;
    _myDropline = platoonTenNotifier.currentPlatoonTen.myDropline;
    _name = platoonTenNotifier.currentPlatoonTen.name;
    _nickname = platoonTenNotifier.currentPlatoonTen.nickname;
    _philosophy = platoonTenNotifier.currentPlatoonTen.philosophy;
    _phone = platoonTenNotifier.currentPlatoonTen.phone;
    _twitter = platoonTenNotifier.currentPlatoonTen.twitter;
    _worstMoment = platoonTenNotifier.currentPlatoonTen.worstMoment;
    _occupation = platoonTenNotifier.currentPlatoonTen.occupation;
    _favPlaceInCamp = platoonTenNotifier.currentPlatoonTen.favPlaceInCamp;
    _favCampActivity = platoonTenNotifier.currentPlatoonTen.favCampActivity;
    _matchPast = platoonTenNotifier.currentPlatoonTen.matchPastInCamp;
