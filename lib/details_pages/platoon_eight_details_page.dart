...
Color shapeDecorationColor =Color.fromRGBO(97, 164, 188, 1);
Color shapeDecorationTextColor =Color.fromRGBO(97, 164, 188, 1);
Color cardBackgroundColor = Colors.white;
Color cardThumbColor = Colors.white;
Color cardThumbBackgroundColor =Color.fromRGBO(97, 164, 188, 1);
Color splashColor =Color.fromRGBO(97, 164, 188, 1);
Color splashColorTwo = Colors.white;
Color iconTextColor =Color.fromRGBO(97, 164, 188, 1);
Color iconTextColorTwo = Colors.white;
Color buttonColor =Color.fromRGBO(97, 164, 188, 1);
Color textColor =Color.fromRGBO(97, 164, 188, 1);
...
PlatoonEightNotifier platoonEightNotifier;
...
class PlatoonEightDetailsPage extends StatefulWidget {
  @override
  _PlatoonEightDetailsPageState createState() => _PlatoonEightDetailsPageState();
}

class _PlatoonEightDetailsPageState extends State<PlatoonEightDetailsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    platoonEightNotifier = Provider.of<PlatoonEightNotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(platoonEightNotifier.currentPlatoonEight.nickname,
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: platoonEightNotifier.currentPlatoonEight.image,
                        fit: BoxFit.cover,
                  ...
                  message: platoonEightNotifier.currentPlatoonEight.name
              ),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(platoonEightNotifier.currentPlatoonEight.name.toUpperCase(),
                            ...
                            (() {
                              if (platoonEightNotifier.currentPlatoonEight.platoonExecutive == "Yes") {
                                return
                                  Row(
                                    children: <Widget>[
                                      SizedBox(width: 10),
  ...
  initState(){
    ...
    _autoBio = platoonEightNotifier.currentPlatoonEight.autoBio;
    _bestMoment = platoonEightNotifier.currentPlatoonEight.bestMoment;
    _courseOfStudy = platoonEightNotifier.currentPlatoonEight.courseOfStudy;
    _graduationYear = platoonEightNotifier.currentPlatoonEight.graduationYear;
    _linkedIn = platoonEightNotifier.currentPlatoonEight.linkedIn;
    _desiredPpaAssignment = platoonEightNotifier.currentPlatoonEight.desiredPpaAssignment;
    _platoonExecutive = platoonEightNotifier.currentPlatoonEight.platoonExecutive;
    _platoonExecutivePosition = platoonEightNotifier.currentPlatoonEight.platoonExecutivePosition;
    _desiredPpaLocation = platoonEightNotifier.currentPlatoonEight.desiredPpaLocation;
    _originState = platoonEightNotifier.currentPlatoonEight.stateOfOrigin;
    _whatsNext = platoonEightNotifier.currentPlatoonEight.whatsNext;
    _stateLiving = platoonEightNotifier.currentPlatoonEight.whereYouLive;
    _bestMoment = platoonEightNotifier.currentPlatoonEight.bestMoment;
    _dob = platoonEightNotifier.currentPlatoonEight.dob;
    _academicQualification = platoonEightNotifier.currentPlatoonEight.academicQualification;
    _almaMater = platoonEightNotifier.currentPlatoonEight.almaMater;
    _email = platoonEightNotifier.currentPlatoonEight.email;
    _facebook = platoonEightNotifier.currentPlatoonEight.facebook;
    _hobbies = platoonEightNotifier.currentPlatoonEight.hobbies;
    _instagram = platoonEightNotifier.currentPlatoonEight.instagram;
    _snapchat = platoonEightNotifier.currentPlatoonEight.snapchat;
    _tikTok = platoonEightNotifier.currentPlatoonEight.tikTok;
    _telegram = platoonEightNotifier.currentPlatoonEight.telegram;
    _myDropline = platoonEightNotifier.currentPlatoonEight.myDropline;
    _name = platoonEightNotifier.currentPlatoonEight.name;
    _nickname = platoonEightNotifier.currentPlatoonEight.nickname;
    _philosophy = platoonEightNotifier.currentPlatoonEight.philosophy;
    _phone = platoonEightNotifier.currentPlatoonEight.phone;
    _twitter = platoonEightNotifier.currentPlatoonEight.twitter;
    _worstMoment = platoonEightNotifier.currentPlatoonEight.worstMoment;
    _occupation = platoonEightNotifier.currentPlatoonEight.occupation;
    _favPlaceInCamp = platoonEightNotifier.currentPlatoonEight.favPlaceInCamp;
    _favCampActivity = platoonEightNotifier.currentPlatoonEight.favCampActivity;
    _matchPast = platoonEightNotifier.currentPlatoonEight.matchPastInCamp;
