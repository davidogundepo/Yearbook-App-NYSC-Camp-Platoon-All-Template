...
Color backgroundColor = Color.fromRGBO(161, 181, 125, 1);
Color appBarTextColor = Colors.white;
Color appBarBackgroundColor = Color.fromRGBO(161, 181, 125, 1);
Color appBarIconColor = Colors.white;
Color materialBackgroundColor = Colors.transparent;
Color shapeDecorationColor = Color.fromRGBO(161, 181, 125, 1);
Color shapeDecorationTextColor = Color.fromRGBO(107, 129, 73, 1.0);
Color cardBackgroundColor = Colors.white;
Color cardThumbColor = Colors.white;
Color cardThumbBackgroundColor = Color.fromRGBO(161, 181, 125, 1);
Color splashColor = Color.fromRGBO(161, 181, 125, 1);
Color splashColorTwo = Colors.white;
Color iconTextColor = Color.fromRGBO(107, 129, 73, 1.0);
Color iconTextColorTwo = Colors.white;
Color buttonColor = Color.fromRGBO(161, 181, 125, 1);
Color textColor = Color.fromRGBO(107, 129, 73, 1.0);
...
PlatoonFiveNotifier platoonFiveNotifier;
...
class PlatoonFiveDetailsPage extends StatefulWidget {
  @override
  _PlatoonFiveDetailsPageState createState() => _PlatoonFiveDetailsPageState();
}

class _PlatoonFiveDetailsPageState extends State<PlatoonFiveDetailsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    platoonFiveNotifier = Provider.of<PlatoonFiveNotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(platoonFiveNotifier.currentPlatoonFive.nickname,
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: platoonFiveNotifier.currentPlatoonFive.image,
                        fit: BoxFit.cover,
                  ...
                  message: platoonFiveNotifier.currentPlatoonFive.name
              ),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(platoonFiveNotifier.currentPlatoonFive.name.toUpperCase(),
                            ...
                            (() {
                              if (platoonFiveNotifier.currentPlatoonFive.platoonExecutive == "Yes") {
                                return
                                  Row(
                                    children: <Widget>[
                                      SizedBox(width: 10),
  ...
  initState(){
    ...
    PlatoonFiveNotifier platoonFiveNotifier = Provider.of<PlatoonFiveNotifier>(context, listen: false);

    _autoBio = platoonFiveNotifier.currentPlatoonFive.autoBio;
    _bestMoment = platoonFiveNotifier.currentPlatoonFive.bestMoment;
    _courseOfStudy = platoonFiveNotifier.currentPlatoonFive.courseOfStudy;
    _graduationYear = platoonFiveNotifier.currentPlatoonFive.graduationYear;
    _linkedIn = platoonFiveNotifier.currentPlatoonFive.linkedIn;
    _desiredPpaAssignment = platoonFiveNotifier.currentPlatoonFive.desiredPpaAssignment;
    _platoonExecutive = platoonFiveNotifier.currentPlatoonFive.platoonExecutive;
    _platoonExecutivePosition = platoonFiveNotifier.currentPlatoonFive.platoonExecutivePosition;
    _desiredPpaLocation = platoonFiveNotifier.currentPlatoonFive.desiredPpaLocation;
    _originState = platoonFiveNotifier.currentPlatoonFive.stateOfOrigin;
    _whatsNext = platoonFiveNotifier.currentPlatoonFive.whatsNext;
    _stateLiving = platoonFiveNotifier.currentPlatoonFive.whereYouLive;
    _bestMoment = platoonFiveNotifier.currentPlatoonFive.bestMoment;
    _dob = platoonFiveNotifier.currentPlatoonFive.dob;
    _academicQualification = platoonFiveNotifier.currentPlatoonFive.academicQualification;
    _almaMater = platoonFiveNotifier.currentPlatoonFive.almaMater;
    _email = platoonFiveNotifier.currentPlatoonFive.email;
    _facebook = platoonFiveNotifier.currentPlatoonFive.facebook;
    _hobbies = platoonFiveNotifier.currentPlatoonFive.hobbies;
    _instagram = platoonFiveNotifier.currentPlatoonFive.instagram;
    _snapchat = platoonFiveNotifier.currentPlatoonFive.snapchat;
    _tikTok = platoonFiveNotifier.currentPlatoonFive.tikTok;
    _telegram = platoonFiveNotifier.currentPlatoonFive.telegram;
    _myDropline = platoonFiveNotifier.currentPlatoonFive.myDropline;
    _name = platoonFiveNotifier.currentPlatoonFive.name;
    _nickname = platoonFiveNotifier.currentPlatoonFive.nickname;
    _philosophy = platoonFiveNotifier.currentPlatoonFive.philosophy;
    _phone = platoonFiveNotifier.currentPlatoonFive.phone;
    _twitter = platoonFiveNotifier.currentPlatoonFive.twitter;
    _worstMoment = platoonFiveNotifier.currentPlatoonFive.worstMoment;
    _occupation = platoonFiveNotifier.currentPlatoonFive.occupation;
    _favPlaceInCamp = platoonFiveNotifier.currentPlatoonFive.favPlaceInCamp;
    _favCampActivity = platoonFiveNotifier.currentPlatoonFive.favCampActivity;
    _matchPast = platoonFiveNotifier.currentPlatoonFive.matchPastInCamp;
