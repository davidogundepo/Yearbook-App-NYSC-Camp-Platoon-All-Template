...
Color backgroundColor = Color.fromRGBO(120, 147, 149, 1);
Color appBarTextColor = Colors.white;
  Color appBarBackgroundColor = Color.fromRGBO(120, 147, 149, 1);
Color appBarIconColor = Colors.white;
Color materialBackgroundColor = Colors.transparent;
Color shapeDecorationColor = Color.fromRGBO(120, 147, 149, 1);
Color shapeDecorationTextColor = Color.fromRGBO(120, 147, 149, 1);
Color cardBackgroundColor = Colors.white;
Color cardThumbColor = Colors.white;
Color cardThumbBackgroundColor = Color.fromRGBO(120, 147, 149, 1);
Color splashColor = Color.fromRGBO(120, 147, 149, 1);
Color splashColorTwo = Colors.white;
Color iconTextColor = Color.fromRGBO(120, 147, 149, 1);
Color iconTextColorTwo = Colors.white;
Color buttonColor = Color.fromRGBO(120, 147, 149, 1);
Color textColor = Color.fromRGBO(120, 147, 149, 1);
...
PlatoonSevenNotifier platoonSevenNotifier;
...
class PlatoonSevenDetailsPage extends StatefulWidget {
  @override
  _PlatoonSevenDetailsPageState createState() => _PlatoonSevenDetailsPageState();
}

class _PlatoonSevenDetailsPageState extends State<PlatoonSevenDetailsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    platoonSevenNotifier = Provider.of<PlatoonSevenNotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(platoonSevenNotifier.currentPlatoonSeven.nickname,
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: platoonSevenNotifier.currentPlatoonSeven.image,
                        fit: BoxFit.cover,
                  ...
                  message: platoonSevenNotifier.currentPlatoonSeven.name
              ),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(platoonSevenNotifier.currentPlatoonSeven.name.toUpperCase(),
                            ...
                            (() {
                              if (platoonSevenNotifier.currentPlatoonSeven.platoonExecutive == "Yes") {
                                return
                                  Row(
                                    children: <Widget>[
                                      SizedBox(width: 10),
  ...
  initState(){
    ...
    PlatoonSevenNotifier platoonSevenNotifier = Provider.of<PlatoonSevenNotifier>(context, listen: false);

    _autoBio = platoonSevenNotifier.currentPlatoonSeven.autoBio;
    _bestMoment = platoonSevenNotifier.currentPlatoonSeven.bestMoment;
    _courseOfStudy = platoonSevenNotifier.currentPlatoonSeven.courseOfStudy;
    _graduationYear = platoonSevenNotifier.currentPlatoonSeven.graduationYear;
    _linkedIn = platoonSevenNotifier.currentPlatoonSeven.linkedIn;
    _desiredPpaAssignment = platoonSevenNotifier.currentPlatoonSeven.desiredPpaAssignment;
    _platoonExecutive = platoonSevenNotifier.currentPlatoonSeven.platoonExecutive;
    _platoonExecutivePosition = platoonSevenNotifier.currentPlatoonSeven.platoonExecutivePosition;
    _desiredPpaLocation = platoonSevenNotifier.currentPlatoonSeven.desiredPpaLocation;
    _originState = platoonSevenNotifier.currentPlatoonSeven.stateOfOrigin;
    _whatsNext = platoonSevenNotifier.currentPlatoonSeven.whatsNext;
    _stateLiving = platoonSevenNotifier.currentPlatoonSeven.whereYouLive;
    _bestMoment = platoonSevenNotifier.currentPlatoonSeven.bestMoment;
    _dob = platoonSevenNotifier.currentPlatoonSeven.dob;
    _academicQualification = platoonSevenNotifier.currentPlatoonSeven.academicQualification;
    _almaMater = platoonSevenNotifier.currentPlatoonSeven.almaMater;
    _email = platoonSevenNotifier.currentPlatoonSeven.email;
    _facebook = platoonSevenNotifier.currentPlatoonSeven.facebook;
    _hobbies = platoonSevenNotifier.currentPlatoonSeven.hobbies;
    _instagram = platoonSevenNotifier.currentPlatoonSeven.instagram;
    _snapchat = platoonSevenNotifier.currentPlatoonSeven.snapchat;
    _tikTok = platoonSevenNotifier.currentPlatoonSeven.tikTok;
    _telegram = platoonSevenNotifier.currentPlatoonSeven.telegram;
    _myDropline = platoonSevenNotifier.currentPlatoonSeven.myDropline;
    _name = platoonSevenNotifier.currentPlatoonSeven.name;
    _nickname = platoonSevenNotifier.currentPlatoonSeven.nickname;
    _philosophy = platoonSevenNotifier.currentPlatoonSeven.philosophy;
    _phone = platoonSevenNotifier.currentPlatoonSeven.phone;
    _twitter = platoonSevenNotifier.currentPlatoonSeven.twitter;
    _worstMoment = platoonSevenNotifier.currentPlatoonSeven.worstMoment;
    _occupation = platoonSevenNotifier.currentPlatoonSeven.occupation;
    _favPlaceInCamp = platoonSevenNotifier.currentPlatoonSeven.favPlaceInCamp;
    _favCampActivity = platoonSevenNotifier.currentPlatoonSeven.favCampActivity;
    _matchPast = platoonSevenNotifier.currentPlatoonSeven.matchPastInCamp;
