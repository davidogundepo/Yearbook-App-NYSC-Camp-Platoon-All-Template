...
Color backgroundColor = Color.fromRGBO(25, 40, 47, 1);
Color appBarTextColor = Colors.white;
Color appBarBackgroundColor = Color.fromRGBO(25, 40, 47, 1);
Color appBarIconColor = Colors.white;
Color materialBackgroundColor = Colors.transparent;
Color shapeDecorationColor = Color.fromRGBO(25, 40, 47, 1);
Color shapeDecorationTextColor = Color.fromRGBO(25, 40, 47, 1);
Color cardBackgroundColor = Colors.white;
Color cardThumbColor = Colors.white;
Color cardThumbBackgroundColor = Color.fromRGBO(25, 40, 47, 1);
Color splashColor = Color.fromRGBO(25, 40, 47, 1);
Color splashColorTwo = Colors.white;
Color iconTextColor = Color.fromRGBO(25, 40, 47, 1);
Color iconTextColorTwo = Colors.white;
Color buttonColor = Color.fromRGBO(25, 40, 47, 1);
Color textColor = Color.fromRGBO(25, 40, 47, 1);
...
PlatoonFourNotifier platoonFourNotifier;
...
class PlatoonFourDetailsPage extends StatefulWidget {
  @override
  _PlatoonFourDetailsPageState createState() => _PlatoonFourDetailsPageState();
}

class _PlatoonFourDetailsPageState extends State<PlatoonFourDetailsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    platoonFourNotifier = Provider.of<PlatoonFourNotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(platoonFourNotifier.currentPlatoonFour.nickname,
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: platoonFourNotifier.currentPlatoonFour.image,
                        fit: BoxFit.cover,
                  ...
                  message: platoonFourNotifier.currentPlatoonFour.name
              ),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(platoonFourNotifier.currentPlatoonFour.name.toUpperCase(),
                            ...
                            (() {
                              if (platoonFourNotifier.currentPlatoonFour.platoonExecutive == "Yes") {
                                return
                                  Row(
                                    children: <Widget>[
                                      SizedBox(width: 10),
  ...
  initState(){
    ...
    PlatoonFourNotifier platoonFourNotifier = Provider.of<PlatoonFourNotifier>(context, listen: false);

    _autoBio = platoonFourNotifier.currentPlatoonFour.autoBio;
    _bestMoment = platoonFourNotifier.currentPlatoonFour.bestMoment;
    _courseOfStudy = platoonFourNotifier.currentPlatoonFour.courseOfStudy;
    _graduationYear = platoonFourNotifier.currentPlatoonFour.graduationYear;
    _linkedIn = platoonFourNotifier.currentPlatoonFour.linkedIn;
    _desiredPpaAssignment = platoonFourNotifier.currentPlatoonFour.desiredPpaAssignment;
    _platoonExecutive = platoonFourNotifier.currentPlatoonFour.platoonExecutive;
    _platoonExecutivePosition = platoonFourNotifier.currentPlatoonFour.platoonExecutivePosition;
    _desiredPpaLocation = platoonFourNotifier.currentPlatoonFour.desiredPpaLocation;
    _originState = platoonFourNotifier.currentPlatoonFour.stateOfOrigin;
    _whatsNext = platoonFourNotifier.currentPlatoonFour.whatsNext;
    _stateLiving = platoonFourNotifier.currentPlatoonFour.whereYouLive;
    _bestMoment = platoonFourNotifier.currentPlatoonFour.bestMoment;
    _dob = platoonFourNotifier.currentPlatoonFour.dob;
    _academicQualification = platoonFourNotifier.currentPlatoonFour.academicQualification;
    _almaMater = platoonFourNotifier.currentPlatoonFour.almaMater;
    _email = platoonFourNotifier.currentPlatoonFour.email;
    _facebook = platoonFourNotifier.currentPlatoonFour.facebook;
    _hobbies = platoonFourNotifier.currentPlatoonFour.hobbies;
    _instagram = platoonFourNotifier.currentPlatoonFour.instagram;
    _snapchat = platoonFourNotifier.currentPlatoonFour.snapchat;
    _tikTok = platoonFourNotifier.currentPlatoonFour.tikTok;
    _telegram = platoonFourNotifier.currentPlatoonFour.telegram;
    _myDropline = platoonFourNotifier.currentPlatoonFour.myDropline;
    _name = platoonFourNotifier.currentPlatoonFour.name;
    _nickname = platoonFourNotifier.currentPlatoonFour.nickname;
    _philosophy = platoonFourNotifier.currentPlatoonFour.philosophy;
    _phone = platoonFourNotifier.currentPlatoonFour.phone;
    _twitter = platoonFourNotifier.currentPlatoonFour.twitter;
    _worstMoment = platoonFourNotifier.currentPlatoonFour.worstMoment;
    _occupation = platoonFourNotifier.currentPlatoonFour.occupation;
    _favPlaceInCamp = platoonFourNotifier.currentPlatoonFour.favPlaceInCamp;
    _favCampActivity = platoonFourNotifier.currentPlatoonFour.favCampActivity;
    _matchPast = platoonFourNotifier.currentPlatoonFour.matchPastInCamp;
