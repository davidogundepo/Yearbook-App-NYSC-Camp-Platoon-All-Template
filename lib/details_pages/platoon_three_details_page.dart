...
Color backgroundColor = Color.fromRGBO(179, 48, 48, 1);
Color appBarTextColor = Colors.white;
Color appBarBackgroundColor = Color.fromRGBO(179, 48, 48, 1);
Color appBarIconColor = Colors.white;
Color materialBackgroundColor = Colors.transparent;
Color shapeDecorationColor = Color.fromRGBO(179, 48, 48, 1);
Color shapeDecorationTextColor = Color.fromRGBO(179, 48, 48, 1);
Color cardBackgroundColor = Colors.white;
Color cardThumbColor = Colors.white;
Color cardThumbBackgroundColor = Color.fromRGBO(179, 48, 48, 1);
Color splashColor = Color.fromRGBO(179, 48, 48, 1);
Color splashColorTwo = Colors.white;
Color iconTextColor = Color.fromRGBO(179, 48, 48, 1);
Color iconTextColorTwo = Colors.white;
Color buttonColor = Color.fromRGBO(179, 48, 48, 1);
Color textColor = Color.fromRGBO(179, 48, 48, 1);
...
PlatoonThreeNotifier platoonThreeNotifier;
...
class PlatoonThreeDetailsPage extends StatefulWidget {
  @override
  _PlatoonThreeDetailsPageState createState() => _PlatoonThreeDetailsPageState();
}

class _PlatoonThreeDetailsPageState extends State<PlatoonThreeDetailsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    platoonThreeNotifier = Provider.of<PlatoonThreeNotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(platoonThreeNotifier.currentPlatoonThree.nickname,
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: platoonThreeNotifier.currentPlatoonThree.image,
                        fit: BoxFit.cover,
                  ...
                  message: platoonThreeNotifier.currentPlatoonThree.name
              ),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(platoonThreeNotifier.currentPlatoonThree.name.toUpperCase(),
                            ...
                            (() {
                              if (platoonThreeNotifier.currentPlatoonThree.platoonExecutive == "Yes") {
                                return
                                  Row(
                                    children: <Widget>[
                                      SizedBox(width: 10),
  ...
  initState(){
    ...
    _autoBio = platoonThreeNotifier.currentPlatoonThree.autoBio;
    _bestMoment = platoonThreeNotifier.currentPlatoonThree.bestMoment;
    _courseOfStudy = platoonThreeNotifier.currentPlatoonThree.courseOfStudy;
    _graduationYear = platoonThreeNotifier.currentPlatoonThree.graduationYear;
    _linkedIn = platoonThreeNotifier.currentPlatoonThree.linkedIn;
    _desiredPpaAssignment = platoonThreeNotifier.currentPlatoonThree.desiredPpaAssignment;
    _platoonExecutive = platoonThreeNotifier.currentPlatoonThree.platoonExecutive;
    _platoonExecutivePosition = platoonThreeNotifier.currentPlatoonThree.platoonExecutivePosition;
    _desiredPpaLocation = platoonThreeNotifier.currentPlatoonThree.desiredPpaLocation;
    _originState = platoonThreeNotifier.currentPlatoonThree.stateOfOrigin;
    _whatsNext = platoonThreeNotifier.currentPlatoonThree.whatsNext;
    _stateLiving = platoonThreeNotifier.currentPlatoonThree.whereYouLive;
    _bestMoment = platoonThreeNotifier.currentPlatoonThree.bestMoment;
    _dob = platoonThreeNotifier.currentPlatoonThree.dob;
    _academicQualification = platoonThreeNotifier.currentPlatoonThree.academicQualification;
    _almaMater = platoonThreeNotifier.currentPlatoonThree.almaMater;
    _email = platoonThreeNotifier.currentPlatoonThree.email;
    _facebook = platoonThreeNotifier.currentPlatoonThree.facebook;
    _hobbies = platoonThreeNotifier.currentPlatoonThree.hobbies;
    _instagram = platoonThreeNotifier.currentPlatoonThree.instagram;
    _snapchat = platoonThreeNotifier.currentPlatoonThree.snapchat;
    _tikTok = platoonThreeNotifier.currentPlatoonThree.tikTok;
    _telegram = platoonThreeNotifier.currentPlatoonThree.telegram;
    _myDropline = platoonThreeNotifier.currentPlatoonThree.myDropline;
    _name = platoonThreeNotifier.currentPlatoonThree.name;
    _nickname = platoonThreeNotifier.currentPlatoonThree.nickname;
    _philosophy = platoonThreeNotifier.currentPlatoonThree.philosophy;
    _phone = platoonThreeNotifier.currentPlatoonThree.phone;
    _twitter = platoonThreeNotifier.currentPlatoonThree.twitter;
    _worstMoment = platoonThreeNotifier.currentPlatoonThree.worstMoment;
    _occupation = platoonThreeNotifier.currentPlatoonThree.occupation;
    _favPlaceInCamp = platoonThreeNotifier.currentPlatoonThree.favPlaceInCamp;
    _favCampActivity = platoonThreeNotifier.currentPlatoonThree.favCampActivity;
    _matchPast = platoonThreeNotifier.currentPlatoonThree.matchPastInCamp;
